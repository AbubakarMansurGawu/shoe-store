            ...
            <Splide options={splideOptions}>
                {story?.news?.map((val, i) => (
                    <SplideSlide key={i} className='mb-0.5'>
                        ...
                        gap-4 pb-2 rounded-lg shadow shadow-slate-200
                        ring-1 ring-slate-200'>
                            ...
                            px-4'>
                                ...
                                <p className='text-sm text-justify lg:text-xs'>
                                    {truncate(val.text, {length: 185},)}</p>
                            </div>
                            <div className='flex items-center justify-center 
                            px-4 w-full bg-gradient-to-b from-slate-900 to-black
                            shadow-md shadow-black text-center text-slate-100
                            py-1.5 button-theme'>
