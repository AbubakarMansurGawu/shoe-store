     ...
     px-3 sticky top-0 left-0 right-0 w-full'>
        <div className='flex items-center gap-3'>
            ...
            <div className='grid items-center'>
                ...
                text-slate-900'>Your Cart
                <span className='bg-theme-cart px-1 py-0.5 
                text-slate-100 font-normal text-xs'>({totalQTY}Items)</span>
                </h1>
            </div>
        </div>
        <div className='flex itms-center'>
            <button type='button' onClick={onClearCartItems} className='rounded bg-theme-cart 
